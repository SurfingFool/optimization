...
var resizePizzas = function(size) {
  ...
  // Removed overcomplicated determineDx function and all associations and replaced
  // with simple newWidth values to equal pizza size.
...
// Added update Positions function as a callback parameter to the window.requestAnimationFrame method
// in the 'scroll' EventListener. Will request that animation function is called before next repaint.
